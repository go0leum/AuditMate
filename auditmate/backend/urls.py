...
from .views import (
    ...
    save_rule, update_rule_name, delete_file, delete_rule
)
...
urlpatterns = [
    ...
    path('api/delete_files/<str:folder_name>/', delete_file, name='delete_file'),
    path('api/delete_rules/<str:rule_name>/', delete_file, name='delete_rule'),
]